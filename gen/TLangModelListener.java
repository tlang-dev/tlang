...
public interface TLangModelListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link TLangModelParser#modelSetAttribut}.
	 * @param ctx the parse tree
	 */
	void enterModelSetAttribut(TLangModelParser.ModelSetAttributContext ctx);
	/**
	 * Exit a parse tree produced by {@link TLangModelParser#modelSetAttribut}.
	 * @param ctx the parse tree
	 */
	void exitModelSetAttribut(TLangModelParser.ModelSetAttributContext ctx);
	/**
