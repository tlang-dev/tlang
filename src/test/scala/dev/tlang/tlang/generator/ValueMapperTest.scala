...
import dev.tlang.tlang.tmpl.lang.ast.{LangGeneric, LangImpl, LangImplFor, LangMultiValue, LangPkg, LangSetAttribute, LangType, LangUse, LangVar}
...
class ValueMapperTest extends AnyFunSuite {
  ...
  test("Replace in uses") {
    ...
    val res = ValueMapper.mapUses(
      Some(
        List(
          LangUse(None, List(TmplInterpretedID(None, call = CallObject(None, List(CallVarObject(None, "one")))), TmplStringID(None, "Package2"))),
          LangUse(None, List(TmplStringID(None, "Package1"), TmplInterpretedID(None, call = CallObject(None, List(CallVarObject(None, "two")))))))), context).get
  ...
  test("Replace in impl") {
    ...
    val context = Context(List(Scope("",values, mutable.Map(), mutable.Map())))
    val impl = LangImpl(None, None, None, TmplInterpretedID(None, call = CallObject(None, List(CallVarObject(None, "name")))), None, None, None)
  ...
  test("Replace in impl fors") {
    ...
    val context = Context(List(Scope("",values, mutable.Map(), mutable.Map())))
    val fors = Some(LangImplFor(None, None, List(LangType(None, TmplInterpretedID(None, call = CallObject(None, List(CallVarObject(None, "for1"))))), LangType(None, TmplInterpretedID(None, call = CallObject(None, List(CallVarObject(None, "for2")))), isArray = false))))
  ...
  test("Replace func name") {
    ...
    val context = Context(List(Scope("",values, mutable.Map(), mutable.Map())))
    val func = LangFunc(None, None, None, None, TmplInterpretedID(None, call = CallObject(None, List(CallVarObject(None, "name")))), None, None)
  ...
  test("Replace content with impl") {
    val values: mutable.Map[String, Value[_]] = mutable.Map("name" -> new TLangString(None, "MyImpl"))
    val context = Context(List(Scope("",values, mutable.Map(), mutable.Map())))
    val impl = Some(List(LangImpl(None, None, None, TmplInterpretedID(None, call = CallObject(None, List(CallVarObject(None, "name")))), None, None, None)))
  ...
  test("Replace content with func") {
    val values: mutable.Map[String, Value[_]] = mutable.Map("name" -> new TLangString(None, "MyFunc"))
    val context = Context(List(Scope("",values, mutable.Map(), mutable.Map())))
    val func = Some(List(LangFunc(None, None, None, None, TmplInterpretedID(None, call = CallObject(None, List(CallVarObject(None, "name")))), None, None)))
  ...
  test("Replace content with call var") {
    ...
    val context = Context(List(Scope("", values, mutable.Map(), mutable.Map())))
    val call = Some(List(LangCallObj(None, None, LangCallVar(None, TmplInterpretedID(None, call = CallObject(None, List(CallVarObject(None, "name"))))), List())))
  ...
  test("Replace call array") {
    ...
    val context = Context(List(Scope("", values, mutable.Map(), mutable.Map())))
    val call = LangCallObj(None, None, LangCallArray(None, TmplInterpretedID(None, call = CallObject(None, List(CallVarObject(None, "name")))), LangOperation(None, Right(LangStringValue(None, TmplInterpretedID(None, call = CallObject(None, List(CallVarObject(None, "position1")))))))), List())
  ...
  test("Replace call var") {
    val values: mutable.Map[String, Value[_]] = mutable.Map("name" -> new TLangString(None, "MyVar"))
    val context = Context(List(Scope("", values, mutable.Map(), mutable.Map())))
    val call = LangCallObj(None, None, LangCallVar(None, TmplInterpretedID(None, call = CallObject(None, List(CallVarObject(None, "name"))))), List())
