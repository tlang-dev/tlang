...
class ExecConditionBlockTest extends AnyFunSuite {
  ...
  test("Simple true condition") {
    ...
    val statement = HelperConditionBlock(HelperCondition(HelperCallObject(List(HelperCallVarObject("var1")))))
  ...
  test("Two true blocks with AND") {
    ...
    val statement = HelperConditionBlock(HelperCondition(HelperCallObject(List(HelperCallVarObject("var1")))),
      Some(ConditionLink.AND), Some(HelperConditionBlock(HelperCondition(HelperCallObject(List(HelperCallVarObject("var2")))))))
    val value = ExecConditionBlock.run(statement, context).toOption.get.get.head.asInstanceOf[TLangBool]
    assert(value.getValue)
  }
  ...
  test("Two true blocks with OR") {
    val context = Context(List(Scope(variables = mutable.Map("var1" -> new TLangBool(true), "var2" -> new TLangBool(true)))))
    val statement = HelperConditionBlock(HelperCondition(HelperCallObject(List(HelperCallVarObject("var1")))),
      Some(ConditionLink.OR), Some(HelperConditionBlock(HelperCondition(HelperCallObject(List(HelperCallVarObject("var2")))))))
    val value = ExecConditionBlock.run(statement, context).toOption.get.get.head.asInstanceOf[TLangBool]
    assert(value.getValue)
  }
  ...
  test("True condition with =") {
    ...
    val statement = HelperConditionBlock(HelperCondition(HelperCallObject(List(HelperCallVarObject("var1"))), Some(ConditionType.EQUAL),Some(HelperCallObject(List(HelperCallVarObject("var2"))) )))
    val value = ExecConditionBlock.run(statement, context).toOption.get.get.head.asInstanceOf[TLangBool]
    assert(value.getValue)
  }
  ...
  test("True condition with >") {
    ...
    val statement = HelperConditionBlock(HelperCondition(HelperCallObject(List(HelperCallVarObject("var1"))), Some(ConditionType.GREATER),Some(HelperCallObject(List(HelperCallVarObject("var2"))) )))
    val value = ExecConditionBlock.run(statement, context).toOption.get.get.head.asInstanceOf[TLangBool]
    assert(value.getValue)
  }
  ...
  test("True condition with <") {
    val context = Context(List(Scope(variables = mutable.Map("var1" -> new TLangInt(42), "var2" -> new TLangInt(1337)))))
    val statement = HelperConditionBlock(HelperCondition(HelperCallObject(List(HelperCallVarObject("var1"))), Some(ConditionType.LESSER),Some(HelperCallObject(List(HelperCallVarObject("var2"))) )))
    val value = ExecConditionBlock.run(statement, context).toOption.get.get.head.asInstanceOf[TLangBool]
    assert(value.getValue)
  }
  ...
  test("True condition with >= (equal numbers)") {
    val context = Context(List(Scope(variables = mutable.Map("var1" -> new TLangInt(42), "var2" -> new TLangInt(42)))))
    val statement = HelperConditionBlock(HelperCondition(HelperCallObject(List(HelperCallVarObject("var1"))), Some(ConditionType.GREATER_OR_EQUAL),Some(HelperCallObject(List(HelperCallVarObject("var2"))) )))
    val value = ExecConditionBlock.run(statement, context).toOption.get.get.head.asInstanceOf[TLangBool]
    assert(value.getValue)
  }
  ...
  test("True condition with <= (equal numbers)") {
    val context = Context(List(Scope(variables = mutable.Map("var1" -> new TLangInt(42), "var2" -> new TLangInt(42)))))
    val statement = HelperConditionBlock(HelperCondition(HelperCallObject(List(HelperCallVarObject("var1"))), Some(ConditionType.LESSER_OR_EQUAL),Some(HelperCallObject(List(HelperCallVarObject("var2"))) )))
    val value = ExecConditionBlock.run(statement, context).toOption.get.get.head.asInstanceOf[TLangBool]
    assert(value.getValue)
  }
  ...
  test("True condition with !=") {
    val context = Context(List(Scope(variables = mutable.Map("var1" -> new TLangInt(42), "var2" -> new TLangInt(1337)))))
    val statement = HelperConditionBlock(HelperCondition(HelperCallObject(List(HelperCallVarObject("var1"))), Some(ConditionType.NOT_EQUAL),Some(HelperCallObject(List(HelperCallVarObject("var2"))) )))
    val value = ExecConditionBlock.run(statement, context).toOption.get.get.head.asInstanceOf[TLangBool]
    assert(value.getValue)
  }
  ...
  test("Two true conditions with AND") {
    val context = Context(List(Scope(variables = mutable.Map("var1" -> new TLangBool(true), "var2" -> new TLangBool(true)))))
    val statement = HelperConditionBlock(HelperCondition(HelperCallObject(List(HelperCallVarObject("var1"))), link = Some(ConditionLink.AND), nextCondition = Some(HelperCondition(HelperCallObject(List(HelperCallVarObject("var2")))))))
    val value = ExecConditionBlock.run(statement, context).toOption.get.get.head.asInstanceOf[TLangBool]
    assert(value.getValue)
  }
  ...
  test("Two true conditions with OR") {
    val context = Context(List(Scope(variables = mutable.Map("var1" -> new TLangBool(true), "var2" -> new TLangBool(true)))))
    val statement = HelperConditionBlock(HelperCondition(HelperCallObject(List(HelperCallVarObject("var1"))), link = Some(ConditionLink.OR), nextCondition = Some(HelperCondition(HelperCallObject(List(HelperCallVarObject("var2")))))))
    val value = ExecConditionBlock.run(statement, context).toOption.get.get.head.asInstanceOf[TLangBool]
    assert(value.getValue)
  }
