...
case class ModelNewEntityValue(`type`: Option[String], params: Option[List[ModelNewAttribute]] = None, attrs: Option[List[ModelNewAttribute]] = None)
  extends ModelNewValueType[ModelNewEntityValue] with ModelSetRefValue {
