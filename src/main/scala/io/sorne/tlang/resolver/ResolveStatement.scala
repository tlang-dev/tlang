...
object ResolveStatement {
  ...
  def resolveStatements(statements: Option[List[HelperStatement]], module: Module, uses: List[DomainUse], scope: Scope, currentResource: Resource): Either[ResolverError, Unit] = {
  ...
  def resolveStatement(statement: HelperStatement, module: Module, uses: List[DomainUse], scope: Scope, currentResource: Resource): Either[ResolverError, Unit] = {
    statement match {
  ...
  def resolveAssignVar(assignVar: AssignVar, module: Module, uses: List[DomainUse], scope: Scope, currentResource: Resource): Either[ResolverError, Unit] = {
    resolveStatement(assignVar.value, module, uses, scope, currentResource)
  }

  def resolveIf(helperIf: HelperIf, module: Module, uses: List[DomainUse], scope: Scope, currentResource: Resource): Either[ResolverError, Unit] = {
  ...
  def resolveFor(helperFor: HelperFor, module: Module, uses: List[DomainUse], scope: Scope, currentResource: Resource): Either[ResolverError, Unit] = {
  ...
  def resolveConditionBlock(conditionBlock: ConditionBlock, module: Module, uses: List[DomainUse], scope: Scope, currentResource: Resource): Either[ResolverError, Unit] = {
  ...
  def resolveCondition(condition: Condition, module: Module, uses: List[DomainUse], scope: Scope, currentResource: Resource): Either[ResolverError, Unit] = {
  ...
  def resolveMultiVal(multiValue: MultiValue, module: Module, uses: List[DomainUse], scope: Scope, currentResource: Resource): Either[ResolverError, Unit] = {
  ...
  def resolveEntity(entity: EntityValue, module: Module, uses: List[DomainUse], scope: Scope, currentResource: Resource): Either[ResolverError, Unit] = {
  ...
  def resolveArray(array: ArrayValue, module: Module, uses: List[DomainUse], scope: Scope, currentResource: Resource): Either[ResolverError, Unit] = {
    array.tbl.foreach(_.foreach(elem => resolveStatement(elem.value, module, uses, scope, currentResource)))
    Right(())
  }

  def resolveCallFuncObjectParams(call: CallFuncObject, module: Module, uses: List[DomainUse], scope: Scope, currentResource: Resource): Either[ResolverError, Unit] = {
