...
object FollowCallToTheEnd {
  ...
  def followCallToTheEnd(call: CallObject, context: Context): Either[ResolverError, Null] = {
  ...
  //  }
  //
  //  /*def followType(value: Value, callObject: CallObject, context: Context, callIndex: Int): Either[ResolverError, Option[Element[_]]] = {
  //    value match {
