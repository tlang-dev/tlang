...
case class CallObject(context: Option[ContextContent], statements: List[CallObjectType], var resolved: Option[CallResolved] = None) extends ComplexValueStatement[CallObject] with AstTmplNode {
