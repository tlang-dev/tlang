...
case class TmplCallObj(context: Option[ContextContent], var calls: List[TmplCallObjType]) extends TmplSimpleValueType[TmplCallObj] with TmplExpression with AstContext {
