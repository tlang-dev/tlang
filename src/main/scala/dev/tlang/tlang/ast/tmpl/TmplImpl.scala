...
case class TmplImpl(context: Option[ContextContent], var annots: Option[List[TmplAnnotation]] = None, var props: Option[TmplProp] = None, var name: TmplID, var fors: Option[TmplImplFor], var withs: Option[TmplImplWith], var content: Option[List[TmplContent[_]]] = None) extends TmplContent[TmplImpl] with AstContext {
