...
case class ModelSetEntity(context: core.Null[ContextContent], name: String, ext: Option[ValueType], params: Option[List[ModelSetAttribute]], attrs: Option[List[ModelSetAttribute]],
