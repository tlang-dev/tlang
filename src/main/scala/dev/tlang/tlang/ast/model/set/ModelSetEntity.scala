...
case class ModelSetEntity(context: Option[ContextContent], name: Type, ext: Option[ValueType], params: Option[List[ModelSetAttribute]], attrs: Option[List[ModelSetAttribute]],
