...
case class ModelSetEntity(context: Option[ContextContent], name: String, ext: Option[ValueType], params: Option[List[ModelSetAttribute]], attrs: Option[List[ModelSetAttribute]],
